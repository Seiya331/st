...
<body>
<?php echo Request::factory("pub/header/typeid/$typeid")->execute()->body(); ?>
<section>
    <div class="mid_content">
        <div class="term-list">
            <?php echo Request::factory("pub/select/typeid/$typeid/destid/$destid")->execute()->body(); ?>
        </div>
        <!--栏目筛选-->
        ...
        <div class="no-content" id="no-content" style="display: none">
            <img src="<?php echo $GLOBALS['cfg_public_url'];?>images/nocon.png"/>
            <p>啊哦，暂时没有相关信息</p>
        </div>
    </div>
