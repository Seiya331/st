<footer>
    <div class="foot">
        <div class="foot_menu">
            <?php require_once ("/Users/zhuguojie/study/st/phone/taglib/footnav.php");$footnav_tag = new Taglib_Footnav();if (method_exists($footnav_tag, 'query')) {$data = $footnav_tag->query(array('action'=>'query',));}?>
