...
<head>
    <meta charset="utf-8">
    <title>愉途主题旅游网{$coreVersion}</title>
...
<table class="content-tab">
    <tr>
        ...
        <td valign="top" class="content-rt-td">
            ...
            <form id="configfrm">
                <div class="w-set-tit bom-arrow"><span class="on"><s></s>愉途主题旅游网授权绑定</span> <a href="javascript:;" class="refresh-btn" onclick="window.location.reload()">刷新</a></div>
