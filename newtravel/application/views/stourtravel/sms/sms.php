...
<head>
    <meta charset="utf-8">
    <title>愉途主题旅游网{$coreVersion}短信平台</title>
...
<!--面包屑-->
    ...
    <div class="manage-nr">
        <div class="sms-base sms-single">
            <div class="b-tit">我的短信 <a target="_blank" href="http://www.stourweb.com/peixun/fangfa-593" style="float:right; padding-right: 10px; color: #fff;">愉途主题旅游网短信签名说明</a></div>
            <div class="b-con">
